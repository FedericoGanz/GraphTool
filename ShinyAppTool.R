...
reset <- function(){
        ...
        # Inputs
                ...
                gb_in_time_limit_2 <<- 2012             # Make sure it makes sense with time_range parameters(start and end) and the other subperiod limits
                gb_in_time_limit_3 <<- 2016
...
selected_default <- function(){
        ...
        # Inputs
                ...
                gb_in_time_limit_1 <<- 2008                                                     # Make sure it makes sense with time_range parameters(start and end) and the other subperiod limits
                gb_in_time_limit_2 <<- 2012                                                     # Make sure it makes sense with time_range parameters(start and end) and the other subperiod limits
                gb_in_time_limit_3 <<- 2016                                                     # Make sure it makes sense with time_range parameters(start and end) and the other subperiod limits
